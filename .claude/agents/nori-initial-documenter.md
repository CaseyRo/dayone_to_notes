...
- Check if the 'nori-sync-docs' skill exists at `/Users/caseyromkes/dev/dayone_to_notes/.claude/skills/nori-sync-docs/SKILL.md`.
  - If it does not exist, skip this step.
- Ask the user if they want to sync all docs.md files to the remote server.
  - If the user declines, skip this step.
- Read and follow `/Users/caseyromkes/dev/dayone_to_notes/.claude/skills/nori-sync-docs/SKILL.md` to sync all noridocs to the remote server.
